...
$info = [
    [
        ...
        'work_date' => 'October 2017 - August 2022',
        'work_descrip' => 'Отчётность, работа с клиентами, работа с поставщиками',
    ],
    ...
    <div class="w3-row-padding">
      ...
      <div class="w3-twothird">
        ...
        <div class="w3-container w3-card w3-white">
          ...
          <div class="w3-container">
            <h5 class="w3-opacity"><b>Могилёвкий государственный университет им.А. Кулешова</b></h5>
